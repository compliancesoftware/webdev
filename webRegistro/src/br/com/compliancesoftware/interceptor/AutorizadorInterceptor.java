	...
	@Override
	  public boolean preHandle(HttpServletRequest request, HttpServletResponse response,Object controller) throws Exception
	 {
		Perfil logado = (Perfil)request.getSession().getAttribute("logado");
	      ...
	      if(uri.contains("consultaRegistro") || uri.endsWith("login") || uri.endsWith("entrar") || uri.contains("resources") || uri.contains("tags/") || uri.contains("error"))
	      {
	    	  return true;
	      }
	      ...
	      if(logado != null) 
	      {
	    	  ...
	    	  requests.add("cadastraRegistro");
	    	  requests.add("atualizarRegistro");

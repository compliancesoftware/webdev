...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
			<form method="post" action="relatorioDeClientePdf">
            	...
            	<br>
            	<hr>
            	<input type="hidden" name="lista" class="form-control" value="${listaIdsDeClientes}">
            	<button class="btn-block btn-white form-control info" type="submit">Emitir Relatório</button>
			</form>